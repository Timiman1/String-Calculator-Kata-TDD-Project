...
namespace TestProject
{
    public class StringCalculatorKataTest
    {
        ...
        [InlineData("//[%][$$][£££££]\n100%200$$300£££££400,500")]
        [InlineData("//[????????????????????????????????????????????????????????????????????????????????????????][£#£][$$$$$$$$$$][!?!?!?!?!?!?!?!?!??!?!?!??!?!?!?!]\n100!?!?!?!?!?!?!?!?!??!?!?!??!?!?!?!200$$$$$$$$$$300£#£400????????????????????????????????????????????????????????????????????????????????????????500")]
        public void Should_Return_1500_When_Adding_100_And_200_And_300_And_400_And_500_Separated_By_Multiple_Custom_Delimeters_Of_Any_Length_And_Commas_And_Newlines(string numbers)
        {
            StringCalculatorKata kata = new StringCalculatorKata();
